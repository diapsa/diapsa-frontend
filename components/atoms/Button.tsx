...
export default function Button({
  ...
  // min-h-11 (44px) es el objetivo táctil mínimo recomendado. Antes el botón
  // solo tenía py-2 y algunos quedaban en 17px de alto.
  const base =
    "inline-flex min-h-11 items-center justify-center rounded-xs px-4 py-2 font-medium transition-all duration-200 ease-out focus:outline-none focus:ring-2 focus:ring-offset-2 cursor-pointer select-none active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed disabled:active:scale-100";
