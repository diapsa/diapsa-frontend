...
const TRAZOS: Record<string, string> = {
  ...
  // Burbujas: gases disueltos en línea.
  dga: "M12 20.25a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5zM6.75 10.5a2.25 2.25 0 100-4.5 2.25 2.25 0 000 4.5zM16.5 8.25a1.5 1.5 0 100-3 1.5 1.5 0 000 3z",
  // Cohete: DIAPSA START.
  start:
  ...
  // Dos ejes desfasados con sus bridas: alineación y balanceo.
  alineacion: "M3 9.5h6.5M14.5 14.5H21M9.5 6v7M14.5 11v7",
