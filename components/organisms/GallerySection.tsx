...
export function GallerySection() {
    ...
    const images = [
        { src: '/images/gallery/campo-1.jpg', alt: 'Explicación del uso de equipo en campo', category: 'Trabajo en campo' },
        { src: '/images/gallery/capacitacion-1.jpeg', alt: 'Capacitaciones en DIAPSA', category: 'Capacitaciones' },
        { src: '/images/gallery/campo-2.jpg', alt: 'Monitoreo de condición - DIAPSA', category: 'Trabajo en campo' },
        { src: '/images/gallery/capacitacion-2.jpg', alt: 'Curso de Certificación Alineamiento de Ejes y Balanceo', category: 'Capacitaciones' },
        { src: '/images/gallery/campo-3.jpg', alt: 'Inspección en DIAPSA', category: 'Trabajo en campo' },
        { src: '/images/gallery/capacitacion-3.jpg', alt: 'Egresados DIAPSA', category: 'Capacitaciones' },
        { src: '/images/gallery/campo-4.jpg', alt: 'Lubricación a equipos', category: 'Trabajo en campo' },
        { src: '/images/gallery/capacitacion-10.jpg', alt: 'Examen validado por DIAPSA', category: 'Capacitaciones' },
        { src: '/images/gallery/campo-5.jpg', alt: 'Inspección de corriente', category: 'Trabajo en campo' },
        { src: '/images/gallery/capacitacion-5.jpg', alt: 'Redacción de informe de inspección', category: 'Capacitaciones' },
        { src: '/images/gallery/campo-6.jpg', alt: 'Profesionista DIAPSA', category: 'Trabajo en campo' },
        { src: '/images/gallery/capacitacion-6.jpg', alt: 'Capacitación en DIAPSA', category: 'Capacitaciones' },
        { src: '/images/gallery/campo-10.jpg', alt: 'Análisis Eléctrico', category: 'Trabajo en campo' },
        { src: '/images/gallery/capacitacion-7.jpg', alt: 'Revisión de Informes', category: 'Capacitaciones' },
        { src: '/images/gallery/campo-8.jpg', alt: 'Uso de equipo termográfico', category: 'Trabajo en campo' },
        { src: '/images/gallery/capacitacion-8.jpg', alt: 'Capacitación en DIAPSA 2', category: 'Capacitaciones' },
        { src: '/images/gallery/campo-25.jpg', alt: 'Termografía Categoría 3', category: 'Trabajo en campo' },
        { src: '/images/gallery/capacitacion-9.jpeg', alt: 'Curso de termografía', category: 'Capacitaciones' },
    ];
