...
export function ValuesSection() {
    ...
    return (
        ...
        <section className="w-full py-14 lg:py-18 border-y-4 border-secondary">
            <div className="sm:px-16 md:px-16 flex flex-col justify-center items-center gap-6">
                ...
                <p className='w-3xl text-center text-lg'>Nuestros principios fundamentales guian cada decisión y acción, asegurando la excelencia operativa
                    y el compromiso con nuestros clientes industriales</p>
                <div className="w-full grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 sm:gap-16 gap-8 justify-items-center mt-6">
